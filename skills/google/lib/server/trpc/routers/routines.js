...
import { getRoutines, getRoutinesDue, getOverdueRoutines, completeRoutine, uncompleteRoutine, skipRoutine, unskipRoutine, skipRoutineToNextDue, completeRoutineToNextDue, getRoutineHistory, } from '../../services/routine-generator-prisma.js';
...
export const routinesRouter = router({
    ...
    update: publicProcedure
        ...
        if (input.data.ownerId !== undefined)
            updateData.ownerId = input.data.ownerId;
        if (input.data.projectId !== undefined)
            updateData.projectId = input.data.projectId;
        if (input.data.recurrenceRule !== undefined)
            updateData.recurrenceRule = input.data.recurrenceRule;
        if (input.data.recurrenceTime !== undefined)
            updateData.recurrenceTime = input.data.recurrenceTime;
