...
import { getGmailClient, getPeopleClient, isGmailConfigured, hasCredentials, hasTokens, getAuthenticatedEmail, } from '../services/gmail-client.js';
...
describe('Gmail tRPC Router', () => {
    ...
    describe('gmail.list', () => {
        ...
        it('should list emails when configured', async () => {
            ...
            vi.mocked(getGmailClient).mockResolvedValue(mockGmail);
    ...
    describe('gmail.search', () => {
        it('should search emails with query', async () => {
            ...
            expect(mockGmail.users.messages.list).toHaveBeenCalledWith(expect.objectContaining({ q: 'subject:budget' }));
...
describe('Contacts tRPC Router', () => {
    ...
    describe('gmail.contactsSearch', () => {
        it('should throw when People API is not configured', async () => {
            ...
            await expect(caller.gmail.contactsSearch({ query: 'John' })).rejects.toThrow('People API not configured');
        });
        it('should search contacts by name', async () => {
            ...
            vi.mocked(getPeopleClient).mockResolvedValue(mockPeople);
        ...
        it('should handle scope errors gracefully', async () => {
            ...
            vi.mocked(getPeopleClient).mockResolvedValue(mockPeople);
            await expect(caller.gmail.contactsSearch({ query: 'John' })).rejects.toThrow('Contacts scope not authorized');
        });
    });
