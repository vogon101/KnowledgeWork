...
describe('tRPC Items Router', () => {
    ...
    describe('items.get', () => {
        ...
        it('should throw NOT_FOUND for non-existent item', async () => {
            await expect(caller.items.get({ id: 999999 })).rejects.toThrow(/not found/i);
        });
    });
    ...
    describe('Type Safety Verification', () => {
        it('should validate input against CreateItemSchema', async () => {
            ...
            await expect(caller.items.create({ title: '' }) // Empty title should fail min(1) at runtime
            ).rejects.toThrow();
        });
        it('should validate status values', async () => {
            ...
            await expect(caller.items.update({
                id: itemId,
